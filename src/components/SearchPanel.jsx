    ...
    <div className="sidebar" aria-label="Search and book details panel">
      <div className="sidebar-header">
        ...
        >
          ...
          <path d="M6 6h10" /><path d="M6 10h10" /><path d="M8 14h8" />
          <path d="M4 6h2" /><path d="M4 10h2" /><path d="M4 14h2" />
        </svg>
            ...
            {loading ? (
              ...
              !loading && !error && (
                <EmptyState
                  ...
                  message={
                    query.trim()
                      ? `No books matched "${query}". Try a different spelling or title.`
                      : 'Type a book title (e.g. "The Hobbit", "Don Quixote") to map its original language.'
                  }
                />
              )
            )}
